...
public:
	...
	//! Reads delete manifest contents (Avro) and binds entries into delete_manifest_entries.
	//! Idempotent — guarded by committed_delete_entries_enumerated and transaction_delete_idx.
	//! Does NOT open delete file contents (that happens in ProcessDeletes / ScanDeleteFile).
...
public:
	...
	//! Watermark into delete_manifest_entries: entries [0, delete_scan_watermark) have had file-content scans done.
