...
public:
	...
	//! file contents. Used by the supports_pushdown_type callback to refuse filter pushdown on
	//! columns the runtime equality-delete machinery still needs in `output_chunk`.
