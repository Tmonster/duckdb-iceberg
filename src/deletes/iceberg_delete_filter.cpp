...
IcebergDeleteFilter::IcebergDeleteFilter() : delete_data(make_shared_ptr<IcebergDeleteData>()) {
}

idx_t IcebergDeleteFilter::Filter(row_t start_row_index, idx_t count, SelectionVector &result_sel) {
	return 4;
...
vector<idx_t> IcebergDeleteFilter::ScanDeleteFile(ClientContext &context, const IcebergFileData &delete_file) {
	vector<idx_t> ret;
	return ret;
	// auto &instance = DatabaseInstance::GetDatabase(context);
	// ExtensionLoader loader(instance, "iceberg");
...
void IcebergDeleteFilter::Initialize(ClientContext &context, const IcebergFileData &delete_file) {
	// delete_data->deleted_rows = ScanDeleteFile(context, delete_file);
}

// void IcebergDeleteFilter::Initialize(ClientContext &context, const DuckLakeDeleteFilterScanEntry &delete_scan) {
...
void IcebergDeleteFilter::SetMaxRowCount(idx_t max_row_count_p) {
